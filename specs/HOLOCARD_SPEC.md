...
> Bundled at planting time on 2026-05-09T15:45:45Z. The authoritative source is the parent repo; this is the self-contained subset every planting needs.
...
For this neighborhood: `id` = `@kody-w/tide-brainstem`.
