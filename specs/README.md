# specs/ — bundled contracts for Tide
...
This directory was bundled on **2026-05-09T15:45:45Z** from `kody-w/RAPP @ fb784f9 (post-Bond-Pulse)`. The contracts here are FROZEN at planting time — they do not change unless an operator runs a `specs refresh` action.
...
- **Lifted at:** 2026-05-09T15:45:45Z
...
```bash
# (future) brainstem run specs-refresh --neighborhood kody-w/tide-brainstem
```
